...
const ClickPointsInteraction: React.FC = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-5" style={{backgroundImage: 'url(https://raw.githubusercontent.com/56b81caaa87941618cfed6dfb4d34047/Blockchain_strategy_game_1732616895/main/src/assets/images/49d127b43a604272be75841e8369501b.jpeg)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
